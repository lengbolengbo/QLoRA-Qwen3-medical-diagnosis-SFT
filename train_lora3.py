...
# trainable params: 692,060,160 || all params: 2,412,635,136 || trainable%: 28.6848
...
args = TrainingArguments(
    output_dir="./output/Qwen3-1.7B-v3",
